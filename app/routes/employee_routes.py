...
def update_employee(
    ...
    return service.update_employee(employee_id, **employee.model_dump())
...
def get_salary_metrics_by_country(
    country: str, service: SalaryMetricsService = Depends(get_salary_metrics_service)
):
